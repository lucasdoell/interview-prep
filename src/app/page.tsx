  ...
  return (
    <div className="flex min-h-full flex-1 flex-col">
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-2 px-4 py-4 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>
            Built for a friend&rsquo;s interview prep — you&rsquo;ve got this.
            Good luck! 🎉
          </p>
          <a
          ...
          >
            ...
            Built by Lucas Doell · @lucasdoell
          </a>
        </div>
        <p className="mx-auto w-full max-w-2xl px-4 pb-4 text-[0.7rem] text-muted-foreground/70">
